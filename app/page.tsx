...
// Logo configuration
const COMPASS_LOGO = '/compass-logo.png'; // Update this with your actual logo path
      ...
      >
        <Card className="w-full overflow-hidden border-0 shadow-lg rounded-2xl bg-white/90 backdrop-blur-sm">
          <CardHeader className="border-b bg-gradient-to-r from-blue-600 to-indigo-500 text-white">
            <CardTitle className="text-2xl font-bold tracking-tight">Compass HRG Assistant</CardTitle>
            {error && (
              <motion.div 
